...
def rbx_print(print_type: int, string: str):
    ...
    write_proc_mem(handle, shellcode_mem + func_ptr_off, ctypes.byref(ctypes.c_uint32(get_relative(aslr(0x820780), shellcode_mem + func_ptr_off) + 1)), ctypes.sizeof(ctypes.c_uint32), None) #write the *relative* address of print to the call instruction in our shellcode
